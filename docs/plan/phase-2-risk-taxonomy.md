...
- [x] OWASP LLM Top 10 2025 覆盖从 6/10 提升到 9/10（LLM08 有记录的缓办决策）
- [x] 任一风险分类结果能回答"对应 NIST AI RMF 哪个具体动作项"（不只是字母大类）
- [x] OWASP ASI 2026 映射表入库并有完整性测试
- [x] TC260 智能体指引条款摘要存档 + 映射表入库
- [x] 领域扩展标签在生产链路可达
- [x] `make test` / `make e2e-full-test` 全绿
