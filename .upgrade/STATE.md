...
- Date: 2026-07-17
- By: claude-code (project-upgrade 文档同步收尾)
- Summary: 三路并行审计后修复全部发现：acceptance_report.md 更新至 v1.3.0、Mode 3 搬迁遗留 stale 引用 6 处清零（doc-check 6→0）、standard-tracking 头部自述修正、MANIFEST benchmarking 描述精确化、docs/README.md 索引补录 design 文档与 archive 段。最小审查全绿（650 passed/1 skipped、e2e-mock 63 passed、ruff clean、doc-check 0、version 1.3.0 一致）。仓库仍处于"待维护者点公开按钮"状态，公开后动作清单见 pre-publication-checklist 报告。
