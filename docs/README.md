...
| [showcase.md](showcase.md) | 项目展示文档（面向答辩/外部介绍的完整特性说明） |
...
| [plan/real-llm-live-path-test.md](plan/real-llm-live-path-test.md) | 测试指令：真实 LLM 联通路径验收（把场景从 Mock 切到真实 DeepSeek + Tavily，验证四阶段现场真跑） |

## archive/ — 历史归档

| 文档 | 说明 |
|------|------|
| [archive/DEMO_README.md](archive/DEMO_README.md) | 旧版 Demo 快速启动说明（内容已并入根 README，存档留痕） |
| [archive/trae_ai_risk_premortem_submission.html](archive/trae_ai_risk_premortem_submission.html) | 比赛提交页面（历史产物归档） |
