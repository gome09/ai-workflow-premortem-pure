...
from stages.json_prompts import JSON_OUTPUT_RULES, STAGE_3_JSON_SYSTEM
from stages.prompts import STAGE_3_SYSTEM
...
class Stage3Executor(BaseStageExecutor):
    ...
    def build_system_prompt(self, ctx: ProjectContext) -> str:
        ...
        template = (
            STAGE_3_JSON_SYSTEM if settings.stage_output_mode == "json_first" else STAGE_3_SYSTEM
        )
