...
Awaiting definition of Phase 0 upgrade requirements (see `docs/improvement-roadmap.md` for candidate scope: 仓库治理 → 安全合规硬缺口 → AI 风险分类补强 → 治理平台化 → 社区打磨).
...
- `.upgrade/MANIFEST.md`
- `docs/improvement-roadmap.md` — 分阶段改进路线图（中国监管合规 / 国际标准 / 开源工程健康度三条坐标轴，阶段0-4 任务清单）
...
Define Phase 0 requirements doc (`.upgrade/stages/phase0-requirements.md`) scoping which items from `docs/improvement-roadmap.md` 阶段0（仓库治理）to tackle first.

## Last Updated

- Date: 2026-07-13
- By: claude-code
- Summary: Mode 1 init + Mode 4 scan/move (RELEASE_CLEANUP.md, release_manifest_v1.0.md) + CLAUDE.md created.
