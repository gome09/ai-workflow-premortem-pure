...
def send_message(session_id: str, body: SendMessageRequest):
    try:
        ai_reply, ctx = session_service.send_message(
            session_id=session_id,
            user_input=body.user_input,
            user_materials=body.user_materials,
        )
        stage_id = current_stage_id(ctx)
