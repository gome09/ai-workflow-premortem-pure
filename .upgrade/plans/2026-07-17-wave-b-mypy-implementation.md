...
- [ ] **Step 5: 写基线报告 `.upgrade/reports/mypy-baseline-20260717.md`**
...
- [ ] **Step 1: 在 `[tool.mypy]` 块之后（若 B2 加了 postgres 豁免则在其后）追加**
...
- [ ] **Step 2: 跑 `uv run mypy`，清零近 strict 错误**
...
- [ ] **Step 3: 更新 `.upgrade/STATE.md` 与父计划 checkbox**
