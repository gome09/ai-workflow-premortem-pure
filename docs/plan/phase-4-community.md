...
- **内容**：`scripts/doc_consistency_check.py` + `make doc-check` + CI 步骤（链接存在性 / make 目标存在性 / 仓库路径存在性三类规则）。设计见 [../spec/supply-chain-security.md](../spec/supply-chain-security.md) 第 7 节。
