...
def test_create_session_attaches_builtin_scenario(monkeypatch, isolated_service):
    ...
    ctx = service.create_session(scenario_id="university_mental_health")
    assert ctx.selected_scenario_id == "university_mental_health"
    assert ctx.scenario_config["domain_profile"] == "university_ai"
    assert ctx.scenario_config["mock_fixture"] == "university_mental_health"
