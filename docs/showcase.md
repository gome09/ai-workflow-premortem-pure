...
> AI Workflow Pre-mortem & Human Oversight Platform · 对话式 · 结构化 · 带人机监督的 AI 项目立项风险预评估平台
>
...
阶段 rerun / revise / rollback / sync-review-actions 作为**显式的阶段操作**集中在 `core/stage_operation_service.py` 与 `api/routers/stage.py`。
